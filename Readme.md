...
The project follows a full data science workflow including data cleaning, feature engineering, clustering evaluation, model selection, and business interpretation.
...
Customers were segmented into four behavioral clusters using K-Means.
